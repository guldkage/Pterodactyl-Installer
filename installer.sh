...
finish(){
    ...
    output ""
    output "Thank you for using the script. Remember to give it a star."
    output "The script has ended. https://$FQDN or http://$FQDN to go to your Panel."
    output ""
    ...
    output ""
    output "You do not need to copy the password under here. This password can also be seen in /var/www/pterodactyl/.env"
    output "You will not use this password in your daily use, this script already configured it for you."
